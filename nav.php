...
function SignOut()
{
    global $my_id,  $fetch_user, $thisName, $thisLast, $thisUser;
    echo " <li class='dropdown-item active nonhover text-capitalize'>$thisName $thisLast</li> 
          <li><a class='dropdown-item' href='index.php?logout=<?php echo $my_id; ?>' onclick='return confirm('are your sure you want to logout?');'>
          <i class='bi me-2 opacity-50 theme-icon bi-box-arrow-left'></i>Logout</a></li>";
}
...
<nav class="navbar fixed-top navbar-expand-lg bg-body-primary w-100 m-0 p-0">
    <div class="container-fluid d-flex justify-content-around">
        ...
        <div class="collapse navbar-collapse mx-4 px-3 " id="navbarSupportedContent">

            <!-- COLOR MODE TOP -->
            <ul class="navbar-nav navbar-right ms-auto mb-2 mb-lg-0">

                <!-- DARKMODE LIGHT MODE SELECTOR -->
